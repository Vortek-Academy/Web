<template>
  <v-container id="text-area" style="color: whitesmoke; width: 75%" fluid>
  </v-container>
</template>
...
This website is operated by <span class="name">VorteK Academy</span>. Throughout the site, the terms “we”, “us” and
“our” refer to <span class="name">VorteK Academy</span>. <span class="name">VorteK Academy</span> offers this website,
including all information, tools and services available from this site to you, the user, conditioned upon your
...
or track the personal information of others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any
...
In no case shall <span class="name">VorteK Academy</span>, our directors, officers, employees, affiliates, agents,
...
profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract,
...
limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall
be limited to the maximum extent permitted by law.

### SECTION 14 - INDEMNIFICATION
<br />

You agree to indemnify, defend and hold harmless <span class="name">VorteK Academy</span> and our parent, subsidiaries,
affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers,
interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party
due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your
...
in accordance with the laws of India and jurisdiction of Jaipur, Rajasthan
...
Questions about the Terms of Service should be sent to us at vortekacademy@gmail.com.
`,
  }),
  mounted() {
    document.getElementById("text-area").innerHTML = marked(this.text);
  },
};
</script>
